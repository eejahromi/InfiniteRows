...
@property (nonatomic, assign) int sectionsHeight;
...
- (void)addInfiniteScrollingWithActionHandler:(void (^)(void))actionHandler {
  ...
  //      NSLog(@"self.contentInset.bottom : %f, ", self.contentInset.bottom );
...
- (void)setScrollViewContentInsetForInfiniteScrolling {
    UIEdgeInsets currentInsets = self.scrollView.contentInset;
 //   NSLog(@"self.originalBottomInset: %f, SVInfiniteScrollingViewHeight: %f, section header: %d:",self.originalBottomInset,SVInfiniteScrollingViewHeight, self.sectionsHeight);
...
- (void)setScrollViewContentInset:(UIEdgeInsets)contentInset {
    [UIView animateWithDuration:0.3
                     ...
                     animations:^{
                        // NSLog(@"self.originalBottomInset: %f, SVInfiniteScrollingViewHeight: %f, section header: %d:, scrollView.contentInset: %f ",self.originalBottomInset,SVInfiniteScrollingViewHeight, self.sectionsHeight,contentInset.bottom);
...
- (void)setState:(SVInfiniteScrollingState)newState {
    ...
    if(hasCustomView) {
        ...
        CGPoint origin = CGPointMake(roundf((self.bounds.size.width-viewBounds.size.width)/2), roundf((self.bounds.size.height-viewBounds.size.height)/2));
       // NSLog(@"origin.y : %f, viewBounds.size.height: %f, self.bounds.size.height: %f, seciton hiehtg: %d", origin.y , viewBounds.size.height, self.bounds.size.height, self.sectionsHeight);
